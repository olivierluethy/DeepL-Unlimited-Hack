document.addEventListener("DOMContentLoaded", () => {
    ...
    sendBtn.addEventListener("click", async () => {
        ...
        if (!tab.url || !deeplRegex.test(tab.url)) {
            return alert("You are not in DeepL. Please switch to DeepL for the extension to work.");
        }
...
Hier ist die vollständige Überarbeitung. Der Button nimmt nun den letzten konvertierten Text und setzt ihn oben ins Feld ein, damit du ihn sofort weiterbearbeiten oder erneut senden kannst.
    */
    ...
    function loadHistory() {
        chrome.storage.local.get({ verlauf: [] }, (result) => {
            ...
            verlauf
                ...
                .forEach((entry) => {
                    ...
                    item.className = "history-entry border-bottom pb-3 mb-3";
        ...
        <div class="d-flex gap-3 mb-2 w-100" style="table-layout: fixed;">
          <!-- Linke Spalte: Original -->
          <div class="w-50" style="overflow-wrap: break-word; min-width: 0;">
            <strong class="d-block small text-secondary">Original:</strong>
            <pre class="mb-0 text-wrap" style="white-space: pre-wrap; word-break: break-word; background: #f8f9fa; padding: 8px; border-radius: 4px; font-size: 0.85rem;">${sanitize(entry.original)}</pre>
            <button class="btn btn-sm btn-link text-decoration-none p-0 mt-1 reuse-original d-flex align-items-center" style="font-size: 0.7rem;">
              <svg xmlns="http://www.w3.org" width="12" height="12" fill="currentColor" class="bi bi-arrow-counterclockwise me-1" viewBox="0 0 16 16">
          ...
          <div class="w-50" style="overflow-wrap: break-word; min-width: 0;">
            ...
            <pre class="mb-0 text-wrap" style="white-space: pre-wrap; word-break: break-word; background: #f8f9fa; padding: 8px; border-radius: 4px; font-size: 0.85rem;">${sanitize(entry.translated)}</pre>
            <button class="btn btn-sm btn-link text-decoration-none p-0 mt-1 reuse-converted d-flex align-items-center" style="font-size: 0.7rem;">
              <svg xmlns="http://www.w3.org" width="12" height="12" fill="currentColor" class="bi bi-arrow-counterclockwise me-1" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2z"/>
                <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966a.25.25 0 0 0 .41-.192z"/>
              </svg> Reuse Converted
            ...
            <!-- Action Buttons Row -->
            <div class="d-flex flex-nowrap gap-1 mt-3 align-items-center">
              <button class="btn btn-outline-primary btn-sm details-entry d-flex align-items-center" data-id="${entry.id}" style="font-size: 0.75rem; padding: 0.25rem 0.4rem;">
                <svg xmlns="http://www.w3.org" width="14" height="14" fill="currentColor" class="bi bi-info-circle me-1" viewBox="0 0 16 16">
      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
      <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
    </svg> Details
              </button>
              <button class="btn btn-outline-success btn-sm copy-btn d-flex align-items-center" data-text="${sanitize(entry.translated)}" style="font-size: 0.75rem; padding: 0.25rem 0.4rem;">
                <svg xmlns="http://www.w3.org" width="14" height="14" fill="currentColor" class="bi bi-clipboard me-1" viewBox="0 0 16 16">
      <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1z"/>
      <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z"/>
    </svg> Copy
              </button>
              <div class="dropdown">
                <button class="btn btn-outline-secondary btn-sm dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown" style="font-size: 0.75rem; padding: 0.25rem 0.4rem;">
                 <svg xmlns="http://www.w3.org" width="14" height="14" fill="currentColor" class="bi bi-download me-1" viewBox="0 0 16 16">
        ...
        <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"/>
                ...
                <ul class="dropdown-menu shadow-sm" style="font-size: 0.8rem;">
                  ...
                  <li><a class="dropdown-item" href="#" data-id="${entry.id}" data-format="word">Word</a></li>
    ...
    <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
      ...
      `;
                    ...
                    item.querySelector(".reuse-original").addEventListener("click", function () {
                        handleReuse(this, entry.original);
                    });

                    item.querySelector(".reuse-converted").addEventListener("click", function () {
